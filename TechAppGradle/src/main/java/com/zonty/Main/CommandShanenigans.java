...
public class CommandShanenigans implements CommandExecutor{
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (sender instanceof Player) {
	    	...
	    	player.sendMessage("Permission of " + victim.getName() + " is set to " + val.toString());
			...
			Bukkit.getServer().getConsoleSender().sendMessage("Permission of " + victim.getName() + " is set to " + val.toString());
		}
